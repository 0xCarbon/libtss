...
use crate::dkls23::utilities::c_types::{
    CBroadcastDerivationPhase2to4, CPhase2Out, CProofCommitment, CSessionData,
    CScalar, CScalarVec, CTransmitInitZeroSharePhase2to4Vec, CUniqueKeepDerivationPhase2to3,
};
...
pub extern "C" fn dkls_phase2(
    ...
    let c_zero_transmit_vec = CTransmitInitZeroSharePhase2to4Vec::from(&zero_transmit);
